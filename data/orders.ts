...
export const recentOrders: Order[] = [
  ...
  },
  {
    ...
    customer: 'Carol Chen',
    initials: 'CC',
    items: ['Matcha Green Tea', 'Blueberry Muffin'],
    total: 9.0,
    status: 'preparing',
    time: '9:30 AM',
    date: '2026-02-21',
  },
  {
    ...
    customer: 'David Kim',
    initials: 'DK',
    items: ['Turkey Club', 'Mango Smoothie'],
    total: 15.75,
    status: 'pending',
    time: '9:35 AM',
    date: '2026-02-21',
...
export const allOrders: Order[] = [
  ...
  {
    id: 'ORD-009',
    customer: 'Iris Thompson',
    initials: 'IT',
    items: ['Matcha Green Tea'],
    total: 5.25,
    status: 'completed',
    time: '8:00 AM',
    date: '2026-02-21',
